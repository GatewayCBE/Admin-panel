...
exports.onSlotCreated = (0, firestore_1.onDocumentCreated)({
    region: "asia-south1",
    ...
    const userId = slotData.user_id ||
        slotData.booking_user_id ||
        slotData.paid_by ||
        "unknown_user";
    console.log(`📊 Updating analytics: turf=${turfId} date=${dateId} user=${userId} amount=${amount}`);
