...
// import { collection, query, where, getDocs, getFirestore, listCollections } from "firebase/firestore";
...
/**
 * Fetch booked time slots for a given sport + court
 */
// -------------------------------------------------------------
// TYPES
// -------------------------------------------------------------
