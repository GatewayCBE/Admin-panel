...
const AllTurfs: React.FC = () => {
 ...
 const filteredTurfs = turfs.filter(turf => {
  // ❌ Exclude "call_now" booking type turfs
if (turf.turf_active_status === false ) return false;
  if (turf.booking_type === "call_now") return false;
        ...
        <div className="content-wrapper">
          ...
          <div className="header-section">
            <div className="header-content">
              <h1>Approved Turfs</h1>
              <p>View All registered turfs from the main database</p>
            </div>
            
            <div className="total-badge">
              <span className="total-badge-label">Total Turfs</span>
<h2 className="total-badge-count">
  {
    turfs.filter(
      t => t.booking_type !== "call_now" && t.turf_active_status === true
    ).length
  }
</h2>
            </div>
